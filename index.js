...
async function manager() {
  ...
  let { name, id, email } = await inquirer.prompt(questions.employeeQuestions("Manager"));
...
async function engineer() {
  let { name, id, email } =
    await inquirer.prompt(questions.employeeQuestions("Engineer"));
...
async function intern() {
  let { name, id, email } =
    await inquirer.prompt(questions.employeeQuestions("Intern"));
